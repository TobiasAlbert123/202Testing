...
public class newModule extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet newModule</title>");     
            ...
            dbTool.logIn(out);
            dbTool.addNewModule(out, request);
            dbTool.writeModules(out);
            
            out.println("<body>");
            out.println("<h1>Servlet newModule at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
